...
Spatial data can be explicitly stored within a `SoilProfileCollection` object and accessed with methods modeled after the [sp](http://cran.at.r-project.org/web/packages/sp/index.html) package: `coordinates()`, `crs()`, and their replacement method equivalents.
...
aqp::crs(sp4) <- '+proj=utm +zone=11 +datum=NAD83'
aqp::crs(sp4)
