...
set.seed(10101)
s <- perturb(x, n = 10, thickness.attr = 'thick.sd', min.thickness = 2)

.a <- list(cex.names = 0.8, color = 'nm', name = NA, show.legend = FALSE, hz.depths = TRUE, plot.depth.axis = FALSE, print.id = FALSE)
