...
.spcL <- spc2mpspline(x, var_name = 'L', lam = 0.1, method = 'est_1cm', vlow = -1000)
.spcA <- spc2mpspline(x, var_name = 'A', lam = 0.1, method = 'est_1cm', vlow = -1000)
.spcB <- spc2mpspline(x, var_name = 'B', lam = 0.1, method = 'est_1cm', vlow = -1000)
