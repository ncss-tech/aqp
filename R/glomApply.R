...
#' @param .fun A function that returns vector with top and bottom depth, when supplied a single profile `p` (as by \code{profileApply})
...
#' @rdname glomApply
#' @export glomApply
glomApply <- function(object, .fun=NULL, ..., chunk.size = 100) {
