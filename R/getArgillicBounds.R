...
#'
#' @param p A single profile SoilProfileCollection
#' @param clay.attr The horizon column name containing clay data; default: `'clay'`
#'
#' @return A numeric vector of the increase depth, given `crit.clay.argillic` as the threshold and a vertical distance threshold of `30` cm.
#' @export
#'
